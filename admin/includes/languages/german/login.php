...
const HEADING_TITLE = '<i class="fa fa-lock"></i> Administrator Login';
...
const BUTTON_CREATE_ADMINISTRATOR = 'Administrator Erstellen';

const ERROR_ACTION_RECORDER = '<strong>Error:</strong> Die maximale Anzahl von Login-Versuchen wurde erreicht. Versuchen Sie es in %s Minuten.';
