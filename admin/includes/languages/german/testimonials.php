...
const HEADING_TITLE = 'Rezension';

const TABLE_HEADING_CUSTOMER_ID = 'Kunden-Nr.';
const TABLE_HEADING_CUSTOMER_NAME = 'Kunden Name';
...
const ENTRY_TESTIMONIAL = 'Rezension';
...
const TEXT_INFO_TESTIMONIAL_SIZE = 'Grösse: %s Wörter';
...
const TEXT_DISPLAY_NUMBER_OF_TESTIMONIALS = 'Angezeigt werden <b>%s</b> bis <b>%s</b> (von <strong>%s</strong> Rezensionen)';
