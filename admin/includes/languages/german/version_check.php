...
const TITLE_INSTALLED_VERSION = 'Installierte Version: <strong>Phoenix v%s</strong>';
...
const VERSION_RUNNING_LATEST = 'Sie verwenden die aktuelle Version von Phoenix.';
const VERSION_UPGRADES_AVAILABLE = <<<'EOT'
<strong>Phoenix %s</strong> ist die aktuellste Version für Sie!<hr>
<a class="alert-link" target="_blank" href="https://phoenixcart.org/forum/viewforum.php?f=22">Zertifizierte Partner</a>
...
Anweisungen gibt es im Phoenix Forum.
EOT;
