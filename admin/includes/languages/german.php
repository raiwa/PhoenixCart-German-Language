...
const HEADER_TITLE_ONLINE_CATALOG = '<i class="fas fa-shopping-cart me-1 text-primary" aria-hidden="true" title="Front-End"></i><span class="border-bottom border-primary">Front-End</span>';
const HEADER_TITLE_PHOENIX_CLUB = '<i class="fas fa-question-circle me-1 text-primary" aria-hidden="true" title="Forum"></i><span class="border-bottom border-primary">Forum</span>';
const HEADER_TITLE_PHOENIX_WIKI = '<i class="fas fa-school me-1 text-primary" aria-hidden="true" title="Handbuch"></i><span class="border-bottom border-primary">Handbuch</span>';
const HEADER_TITLE_CERTIFIED_DEVELOPERS = '<i class="fas fa-laptop-code me-1 text-primary" aria-hidden="true" title="Zertifizierte Partner"></i><span class="border-bottom border-primary">Zertifizierte Partner</span>';
const HEADER_TITLE_CERTIFIED_ADDONS = '<i class="fas fa-folder-plus me-1 text-primary" aria-hidden="true" title="Addons"></i><span class="border-bottom border-primary">Addons</span>';
const HEADER_TITLE_LOGOFF = '<i class="fas fa-lock me-1" aria-hidden="true" title="Ausloggen"></i><span class="border-bottom border-danger">%s, sicher ausloggen</span>';
...
const GET_HELP = '<img alt="" src="images/icon_phoenix.png" class="me-2">Hilfe';
