...
*/
  ...
  const MODULE_CONTENT_TESTIMONIALS_WRITE_NICKNAME = 'Ihr Name';
  const MODULE_CONTENT_TESTIMONIALS_WRITE_NICKNAME_PLACEHOLDER = 'Ihr Name (oder Spitzname)';
  const MODULE_CONTENT_TESTIMONIALS_WRITE_TEXT = 'Rezension';
  const MODULE_CONTENT_TESTIMONIALS_WRITE_TEXT_PLACEHOLDER = 'Was möchten Sie sagen?';
  const MODULE_CONTENT_TESTIMONIALS_WRITE_BUTTON_TEXT_SEND = 'An den Ladenbesitzer senden';

  const MODULE_CONTENT_TESTIMONIALS_WRITE_THANK_YOU = 'Vielen Dank, %s. Ihre Rezension wurde an den Ladenbesitzer gesendet.';
