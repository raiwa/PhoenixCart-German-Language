...
*/
  ...
  const MODULE_CONTENT_FOOTER_TEXT_DESCRIPTION = 'Fügt einen Text-Block an der Fußzeile der Seite ein';

  const MODULE_CONTENT_FOOTER_TEXT_HEADING_TITLE = 'Über uns';
