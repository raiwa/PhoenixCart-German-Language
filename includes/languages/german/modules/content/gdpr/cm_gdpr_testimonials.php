...
*/
  ...
  const MODULE_CONTENT_GDPR_TESTIMONIALS_TITLE = 'DSGVO - Testimoniale';
  const MODULE_CONTENT_GDPR_TESTIMONIALS_DESCRIPTION = 'Dieses Modul zeigt die Anzahl der vom Kunden verfassten Testimonials an.';

  const MODULE_CONTENT_GDPR_TESTIMONIALS_PUBLIC_TITLE = 'Testimonials';
  const MODULE_CONTENT_GDPR_TESTIMONIALS_NUM_TESTIMONIALS = 'Sie haben <br><span class="h1"><span class="num_testimonials">%s</span></span><br>Testimonial(e) geschrieben';
