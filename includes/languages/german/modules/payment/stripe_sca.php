...
*/
  ...
  const MODULE_PAYMENT_STRIPE_SCA_TEXT_INSTRUCTIONS = '<p>Anleitung:<br><i class="fas fa-external-link-alt me-2"></i>&nbsp;<a href="https://phoenixcart.org/phoenixcartwiki/index.php?title=Payment#Stripe_SCA" target="_blank" rel="noopener">Webhook-Konfiguration</a></p>';
